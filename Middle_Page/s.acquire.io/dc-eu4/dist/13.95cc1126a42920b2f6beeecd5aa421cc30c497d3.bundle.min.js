/** Tagove! **/ ! function() {
    var e = "prototype",
        t = t || {};
    t.scope = {}, t.arrayIteratorImpl = function(e) {
        var t = 0;
        return function() {
            return t < e.length ? {
                done: !1,
    ...
    }, t.ASSUME_ES5 = !1, t.ASSUME_NO_NATIVE_MAP = !1, t.ASSUME_NO_NATIVE_SET = !1, t.SIMPLE_FROUND_POLYFILL = !1, t.ISOLATE_POLYFILLS = !1, t.defineProperty = t.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(t, o, a) {
        return t == Array[e] || t == Object[e] ? t : (t[o] = a.value, t)
    ...
    }, t.global = t.getGlobal(this), t.IS_SYMBOL_NATIVE = "function" == typeof Symbol && "symbol" == typeof Symbol("x"), t.TRUST_ES6_POLYFILLS = !t.ISOLATE_POLYFILLS || t.IS_SYMBOL_NATIVE, t.polyfills = {}, t.propertyToPolyfillSymbol = {}, t.POLYFILL_PREFIX = "$jscp$", t.polyfill = function(e, o, a, n) {
        o && (t.ISOLATE_POLYFILLS ? t.polyfillIsolated(e, o, a, n) : t.polyfillUnisolated(e, o, a, n))
    }, t.polyfillUnisolated = function(e, o, a, n) {
        for (a = t.global, e = e.split("."), n = 0; n < e.length - 1; n++) {
            var i = e[n];
            if (!(i in a)) return;
            a = a[i]
        }(o = o(n = a[e = e[e.length - 1]])) != n && null != o && t.defineProperty(a, e, {
            configurable: !0,
            writable: !0,
            value: o
        })
    }, t.polyfillIsolated = function(e, o, a, n) {
        var i = e.split(".");
        e = 1 === i.length, n = i[0], n = !e && n in t.polyfills ? t.polyfills : t.global;
        for (var r = 0; r < i.length - 1; r++) {
            var s = i[r];
            if (!(s in n)) return;
            n = n[s]
        }
        i = i[i.length - 1], null != (o = o(a = t.IS_SYMBOL_NATIVE && "es6" === a ? n[i] : null)) && (e ? t.defineProperty(t.polyfills, i, {
            configurable: !0,
            writable: !0,
            value: o
        }) : o !== a && (t.propertyToPolyfillSymbol[i] = t.IS_SYMBOL_NATIVE ? t.global.Symbol(i) : t.POLYFILL_PREFIX + i, i = t.propertyToPolyfillSymbol[i], t.defineProperty(n, i, {
            configurable: !0,
            writable: !0,
            value: o
        })))
    }, t.s = function() {}, t.polyfill("Symbol", function(o) {
        if (o) return o;
        var a = function(e, o) {
            this.x$$symbol$id_ = e, t.defineProperty(this, "description", {
                configurable: !0,
                writable: !0,
                value: o
            })
        ...
        a[e].toString = function() {
            return this.x$$symbol$id_
        };
        var n = 0,
            i = function(e) {
                if (this instanceof i) throw new TypeError("Symbol is not a constructor");
                return new a("jscomp_symbol_" + (e || "") + "_" + n++, e)
            };
        return i
    }, "es6", "es3"), t.sIterator = function() {}, t.polyfill("Symbol.iterator", function(o) {
        if (o) return o;
        o = Symbol("Symbol.iterator");
        for (var a = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), n = 0; n < 10; n++) {
            var i = t.global[a[n]];
            "function" == typeof i && "function" != typeof i[e][o] && t.defineProperty(i[e], o, {
                configurable: !0,
                writable: !0,
                value: function() {
                    return t.iteratorPrototype(t.arrayIteratorImpl(this))
                }
            })
        }
        return o
    }, "es6", "es3"), t.sAsyncIterator = function() {}, t.iteratorPrototype = function(e) {
        return e = {
            next: e
        }, e[Symbol.iterator] = function() {
            return this
        }, e
    }, t.iteratorFromArray = function(e, t) {
    ...
    }, t.polyfill("Array[c$pr].keys", function(e) {
        return e || function() {
            return t.iteratorFromArray(this, function(e) {
                return e
            })
        }
    }, "es6", "es3"), $tgwbpk([13], {
            ...
            var a = {
                ...
                dynamicViews: {
                    ...
                    be477: {
                        ...
                        "thread-new": function(e) {
                            o.e(65).then(function() {
                                var t = [o(516)];
                                e.apply(null, t)
                            }.bind(this)).catch(o.oe)
                        }
                    ...
                    "09a05,84389,62019": {
                        launcher: function(e) {
                            o.e(60).then(function() {
                                var t = [o(517)];
                                e.apply(null, t)
                            }.bind(this)).catch(o.oe)
                        },
                        form_online: function(e) {
                            o.e(61).then(function() {
                                var t = [o(518)];
                                e.apply(null, t)
                            }.bind(this)).catch(o.oe)
                        },
                        "chat-feedback": function(e) {
                            o.e(62).then(function() {
                                var t = [o(519)];
                                e.apply(null, t)
                            }.bind(this)).catch(o.oe)
                        }
                    ...
                    "2dad0,843e0": {
                        "thread-new": function(e) {
                            o.e(67).then(function() {
                                var t = [o(521)];
                                e.apply(null, t)
                            }.bind(this)).catch(o.oe)
                        },
                        "chat-feedback": function(e) {
                            o.e(68).then(function() {
                                var t = [o(522)];
                                e.apply(null, t)
                            }.bind(this)).catch(o.oe)
                        }
                ...
                templates: {
                    "rtc-room-call-controls": o(500),
                    "rtc-room-call-videos": o(501),
                    "rtc-room-incoming-call-alert": o(502),
                    "rtc-room-screen-share-control": o(503),
                    "rtc-room-screen-videos": o(504),
                    "user-screen-template": o(505),
                    "user-video-template": o(506),
                    "thread-list": o(507),
                    "thread-view": o(508),
                    "thread-new": o(509),
                    "chat-feedback": o(510),
                    cobrowseonly: o(460),
                    loading: o(511),
                    connection_status: o(512),
                    "cobrowseonly-ui": o(460),
                    launcher: o(459),
                    form_online: o(513),
                    "cobrowser-url-bar": function(e) {
                        var t = o(453),
                            n = o(454);
                        e(t, n = ((n = (n + "\n" + o(455)).replace(/BASEURL/g, a.baseURL)) + "").replace(/ASSETURL/g, a.assetUrl))
                    },
                    "camera-settings": function(e) {
                        o.e(11).then(function() {
                            var t = [o(402), o(403)];
                            (function(t, o) {
                                t = ((t = ((t = t.replace("{STYLES}", "<style>" + o + "</style>")) + "").replace(/BASEURL/g, a.baseURL)) + "").replace(/ASSETURL/g, a.assetUrl), e(t)
                            }).apply(null, t)
                        }).catch(o.oe)
                    },
                    popup_ui: function(e) {
                        o.e(50).then(function() {
                            var t = [o(529), o(530)];
                            e.apply(null, t)
                        }.bind(this)).catch(o.oe)
                    }
                },
                getTheme: function(e, t, o) {
                    if (t = (t.chat_window || "modern").replace("_03", ""), a.launcherViews && void 0 !== a.launcherViews[t] && (a.templates.launcher = a.launcherViews[t]), a.dynamicViews && 0 < Object.keys(a.dynamicViews).length)
                        for (var n in a.dynamicViews)
                            if (0 <= n.split(",").indexOf(e) && 0 < Object.keys(a.dynamicViews[n]).length)
                                for (var i in a.dynamicViews[n]) a.templates[i] = a.dynamicViews[n][i];
                    o(a)
                }
            };
            e.exports = a
